...
function separarcpn(){
    ...
    //DatoCPN son los datos del segundo documento de texto
    //Aux centro son las cordenadas de cada puesto
    //Aux punto son las cordenadas de cada puntode venta
    //console.log(DatoCPN);
    //console.log(contlenb);
    //if(aux===1 && auy===1){
        calculohoja(auxcentro,auxpunto,DatoCPN,contlenb);//Calcula la hoja de ruta que se pida
    //}      
}
...
function mensaje(){ //FUNCIÓN TEMPORAL PARA TEST
    if(DatoGen !== undefined && DatoCPN !== undefined){
        ...
        //Aqui debo mostrar los camiones y la distancia con los productos transportados
    }
    else{
        console.log("NULL");
    }
